		...
		query = """
			...
			case 
				when am.move_type = 'in_refund' then 
					case 
						when am.reversed_entry_id is not null then round(coalesce(am2.currency_tc,0.00),3)
						else round(coalesce(am.currency_tc,0.00),3)
					end
				...
				when am.move_type = 'in_refund' then 
					case
						when am.reversed_entry_id is not null then 
							(-1.00)*coalesce(am.total_sale_taxed,0.00)*round(coalesce(am2.currency_tc,0.00),3)

						else
							(-1.00)*coalesce(am.total_sale_taxed,0.00)*round(coalesce(am.currency_tc,0.00),3)
							
					end
					
				else 
					coalesce(am.total_sale_taxed,0.00)*round(coalesce(am.currency_tc,0.00),3)
			...
			case 
				when am.move_type = 'in_refund' then 
					case
						when am.reversed_entry_id is not null then 
							(-1.00)*coalesce(am.total_sale_igv,0.00)*round(coalesce(am2.currency_tc,0.00),3)

						else
							(-1.00)*coalesce(am.total_sale_igv,0.00)*round(coalesce(am.currency_tc,0.00),3)
									
					end
							
				else 
					coalesce(am.total_sale_igv,0.00)*round(coalesce(am.currency_tc,0.00),3)
			end monto_igv_1,
			...
			case 
				when am.move_type = 'in_refund' then 
					case
						when am.reversed_entry_id is not null then 
							(-1.00)*(coalesce(am.total_sale_free,0.00) + coalesce(am.total_sale_unaffected,0.00) + coalesce(am.total_sale_exonerated,0.00))*round(coalesce(am2.currency_tc,0.00),3)

						else
							(-1.00)*(coalesce(am.total_sale_free,0.00) + coalesce(am.total_sale_unaffected,0.00) + coalesce(am.total_sale_exonerated,0.00))*round(coalesce(am.currency_tc,0.00),3)
									
					end
							
				else 
					(coalesce(am.total_sale_free,0.00) + coalesce(am.total_sale_unaffected,0.00) + coalesce(am.total_sale_exonerated,0.00))*round(coalesce(am.currency_tc,0.00),3)
			...
			case 
				when am.move_type = 'in_refund' then 
					case
						when am.reversed_entry_id is not null then 
							(-1.00)*coalesce(am.total_venta,0.00)*round(coalesce(am2.currency_tc,0.00),3)

						else
							(-1.00)*coalesce(am.total_venta,0.00)*round(coalesce(am.currency_tc,0.00),3)
											
					end
									
				else 
					coalesce(am.total_venta,0.00)*round(coalesce(am.currency_tc,0.00),3)
			...
			left join account_move am2 on am2.reversed_entry_id = am.id 
