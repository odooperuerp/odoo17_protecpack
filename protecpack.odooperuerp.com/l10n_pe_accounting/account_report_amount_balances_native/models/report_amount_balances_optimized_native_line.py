...
class ReportAmountBalancesOptimizedNativeLine(models.Model):
	...
	name=fields.Char(string="Denominación", readonly=True)

	name_account=fields.Char(string="Código-Denominación", readonly=True)
	...
	resultados_naturaleza_perdidas=fields.Char(string="Resultados Naturaleza Pérdidas", readonly=True)
	resultados_naturaleza_ganancias=fields.Char(string="Resultados Naturaleza Ganancias", readonly=True)

	resultados_funcion_perdidas=fields.Char(string="Resultados Función Pérdidas", readonly=True)
	resultados_funcion_ganancias=fields.Char(string="Resultados Función Ganancias", readonly=True)
