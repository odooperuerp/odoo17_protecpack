...
class AccountMove(models.Model):
    ...
    is_special_tc = fields.Boolean(string='Activar Tipo Cambio Manual',default=False, 
        help='Activar el Tipo de Cambio personalizado por el usuario')
...
class AccountMoveLine(models.Model):
    ...
    def _recompute_debit_credit_from_amount_currency(self):
        ...
        for line in self:
            ...
            if line.move_id.type in ['in_invoice','in_refund','out_refund'] and not line.move_id.is_special_tc:
            # Recompute the debit/credit based on amount_currency/currency_id and date.
                company_currency = line.company_id.currency_id or self.env.company_id.currency_id
                ...
                if line.currency_id and company_currency and line.currency_id != company_currency and not line.move_id.is_special_tc:
                    ...
                    #balance = line.currency_id._convert(balance, company_currency, line.company_id,
    ...
    def _get_fields_onchange_subtotal(self, price_subtotal=None, move_type=None, currency=None, company=None, date=None):
        ...
        if self.move_id.type in ['in_invoice','in_refund','out_refund'] and self.currency_id != self.company_id.currency_id and not self.move_id.is_special_tc:
