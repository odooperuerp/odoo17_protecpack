...
class AccountPayableReportCurrentDateLine(models.TransientModel):
    _name = "account.payable.report.current.date.line"
    _description = "Reporte de Cuentas por Pagar a la Fecha"
    _rec_name = 'move_line_id'
    _order = "date_maturity desc"

    wizard_account_payable_report_current_date_id = fields.Many2one('wizard.account.payable.report.current.date',
