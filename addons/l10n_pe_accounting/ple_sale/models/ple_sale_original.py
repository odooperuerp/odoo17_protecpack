...
class PleSale(models.Model):
	...
	"""def generar_libro(self):
		...
		for line in records:
			...
			registro.append((0,0,{
				'invoice_id':line['move_id'] or False,
				'invoice_id_2':line['invoice_id_2'] or False,
				...
				'tipo_documento_cliente':line['tipo_documento_cliente'] or '',
				'numero_documento_cliente':line['numero_documento_cliente'] or '',
