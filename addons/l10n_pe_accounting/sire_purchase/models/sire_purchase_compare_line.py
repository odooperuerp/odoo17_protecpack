...
class SirePurchaseCompareLine(models.Model):
	_name='sire.purchase.compare.line'
	_description = "SUNAT SIRE Purchase Compare Line"
	...
	nro_doc_identidad_proveedor = fields.Char(string="Nro Doc Identidad",readonly=True)
