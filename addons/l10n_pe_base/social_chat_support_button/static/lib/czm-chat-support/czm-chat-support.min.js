    ...
    $.fn.czmChatSupport = function (options) {
        ...
        return this.each(function () {
            ...
            if ((settings.sound !== false) && (buttonOnline == true)) {
                ...
                setTimeout(function () {
                    ...
                    if (settings.sound === true) {
                        ...
                        settings.sound = window.location.origin + '/social_chat_support_button/static/lib/czm-chat-support/sound/notification.mp3';
            ...
            if ((settings.changeBrowserTitle !== false) && (buttonOnline == true)) {
                ...
                var newFavicon = '/social_chat_support_button/static/src/assets/img/browser-title-number.png';
